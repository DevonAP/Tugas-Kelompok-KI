...
// =========================
int main() {
    string plaintext = "WOMAYGAT";
    string key = "81384935"; // 8 karakter
    cout << "Plaintext: " << plaintext << endl;

    vector<int> cipher_bits = des_encrypt(plaintext, key);
    cout << "Ciphertext (bits): ";
    for (int i = 0; i < 64; ++i) cout << cipher_bits[i];    
    cout << endl;

    cout << "Ciphertext (text): " << bits_to_text(cipher_bits) << endl;

    string decrypted = des_decrypt(cipher_bits, key);
